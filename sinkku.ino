...
#define PIN_SCE   4  // LCD CS  .... Pin 3
#define PIN_RESET 2  // LCD RST .... Pin 1
...
//Leonardo (Uno in comments) > AD9850 Board Anschlüsse        
#define RST     11 // Arduino 11 > Board RST - Reset
#define FQ       9 // Arduino 10 > Board FQ - Frequenz Update
#define CLK      8 // Arduino  9 > Board CLK - Takt
#define DATA    10 // Arduino  8 > Board DATA - Daten
...
int a = 0;
long freq = 1000; // frequency
int pos = 3;     // position to change
...
void loop()
{
  ...
  //char b[6];
  aa=readButtons(5);
  //if (aa==0) // no buttons pressed
  //gotoXY(4,1);
  //LcdString("Button:");
  if (aa>0) // someone pressed a button!
    switch(aa) {
	case 1: left(); break;
	case 2: minus(); break;
	case 3: plus(); break;
  ...
  */
  ...
  gotoXY(4,4);
  LcdString(b);
  delay(300); // give the human time to read LCD
  */
